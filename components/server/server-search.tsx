  ...
  return (
    <>
        <button
            ...
            gap-x-2 w-full hover:bg-zin-700/10 dark:hover:bg-zinc-700/50 transition">
            ...
            <kbd className="pointer-event-none inline-flex h-5 select-none items-center
            gap-1 rounded border bg-muted px-1.5 font-mono text-[10px] font-medium
            text-mutedforeground ml-auto">
